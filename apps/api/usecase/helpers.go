...
func convertItineraryFromPlaces(places []*models.TripPlace, startTime string) []models.TripPlace {
...
func calculateTimeline(places []*models.TripPlace, startTime string, mlResp map[string]interface{}) []models.TripPlace {
	// 簡易実装: 移動時間は30分固定（MVP）
